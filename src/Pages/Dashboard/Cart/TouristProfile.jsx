...
const TouristProfile = () => {
    ...
    const handleShare = async e =>{
        ...
        const storyItems = {spot, story,  speaker_name
              :user.displayName, speaker_email: user.email, speaker_img: user.photoURL		}
    ...
    return (
        <div>
            <div className="p-6 sm:p-12 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800 h-[650px]">
	<div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
		<img src={user?.photoURL} alt="" className="self-center flex-shrink-0 w-24 h-24 border rounded-full md:justify-self-start bg-gray-500 dark:bg-gray-500 border-gray-700 dark:border-gray-300" />
		<div className="flex flex-col">
			<h4 className="text-lg font-semibold text-center md:text-left"> {user?.displayName} </h4>
			
		</div>
	</div>
	<p className="text-gray-400 dark:text-gray-600 mt-12"> I am a tourist. I love travelling most. Until now maybe I have visited around 42 countries of the world. Nature attracts me more. I always try to spend my times with nature. </p>
    <div className="flex flex-col w-full">
		<SectionTitle
		heading={'Share Experience'}></SectionTitle>
			<form onSubmit={handleShare} >
			<label htmlFor="" className=" mb-4">Tourist spot name:</label> <br />

			<input type="text" name="spot" id="" className=" lg:w-96 mb-4 text-black" required/>

			<br />
			<label  className=" mb-4"> Share your experience</label> <br />
			<input required type="text" name="story" id="" className=" w-96 h-12 bg-slate-400 text-black mb-4"/>
			<input
