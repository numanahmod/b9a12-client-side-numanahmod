...
const AdminProfile = () => {
    ...
    return (
        <div>
            <div className="p-6 sm:p-12 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800">
	
    <div className="flex flex-col max-w-md p-6 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800">
	<img src={user?.photoURL} alt="" className="flex-shrink-0 object-cover h-64 rounded-sm sm:h-96 bg-gray-500 dark:bg-gray-500 aspect-square" />
	<div>
		<h2 className="text-xl font-semibold">Admin Name: <span className=" text-orange-600">{user?.displayName}</span></h2>
		<span className="block pb-2 text-sm text-gray-400 dark:text-gray-600">CTO of Company Inc.</span>
		<p></p>
