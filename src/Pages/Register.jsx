...
const Register = () => {
    ...
    return (
        <div className="justify-center place-items-center lg:ml-[450px] md:ml-[200px] m-5  mb-12 p-20">
	...
	<form onSubmit={handleRegister} noValidate="" action="" className="space-y-4">
		...
		<button className="block w-full p-3 text-center rounded-sm text-gray-900 bg-purple-600 font-bold"> Register </button>
	</form>
	{
