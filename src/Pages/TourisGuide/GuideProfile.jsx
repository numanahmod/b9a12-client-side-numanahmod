...
const GuideProfile = () => {
    ...
    return (
        <div>
            <div className="flex flex-col justify-center max-w-full h-[700px] p-6 shadow-md rounded-xl sm:px-12 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800">
	<img src={user.photoURL} alt="" className=" lg:w-48 lg:h-48 mx-auto rounded-full bg-gray-500 dark:bg-gray-500 aspect-square -mt-44" />
	<div className="space-y-4 text-center divide-y divide-gray-700 dark:divide-gray-300">
		<div className="my-2 space-y-1">
			...
			<p className="px-5 text-xs sm:text-base text-gray-400 dark:text-gray-600">Tourist Guide </p>
			<p className="px-5 text-xs sm:text-base text-gray-400 dark:text-gray-600"> {user.email} </p>
		</div>
